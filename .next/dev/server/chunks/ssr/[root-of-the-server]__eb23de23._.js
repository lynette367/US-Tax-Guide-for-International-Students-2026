...
const guides = [
    ...
    {
        slug: "opt-1040-fix",
        title: "救急！OPT 报税发现填成了 1040 (Resident) 怎么办？4.15 前的最后补救指南",
        description: "OPT 报税填错 1040 别慌！4.15 前最后补救：手把手教你填写 1040-X 将 Resident 修正为 Nonresident。详解误领 Standard Deduction 的追缴步骤，附 IRS 邮寄清单，避开签证影响。",
        ...
        sections: [
            ...
            },
            {
                ...
                blocks: [
                    {
                        type: "paragraph",
                        text: "Non-resident 绝大多数情况下 没有 标准扣除额。"
                    }
                ]
            },
            {
            ...
            },
            {
                ...
                blocks: [
                    {
                        type: "paragraph",
                        text: "介绍 Form 1040-X (修正案)  的基本概念，告诉他们不要惊慌，但必须修正（1040 修正链接）。如果需要一对一指导如何填表，在这里顺势推荐 1040-NR 教程。"
                    }
                ]
            },
            {
                ...
                blocks: [
                    {
                        type: "paragraph",
                        text: "本文为报税修正指南的经验整理，不构成税务或法律建议。若你的情况涉及复杂收入或身份切换，请先做判断或咨询专业人士。"
                    }
                ]
            }
        ],
...
"[project]/src/app/(guides)/guides/opt-1040-fix/page.tsx [app-rsc] (ecmascript)", ((__turbopack_context__, module, exports) => {

const e = new Error("Could not parse module '[project]/src/app/(guides)/guides/opt-1040-fix/page.tsx', file not found");
e.code = 'MODULE_UNPARSABLE';
throw e;
}),
"[project]/src/app/(guides)/guides/opt-1040-fix/page.tsx [app-rsc] (ecmascript, Next.js Server Component)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/src/app/(guides)/guides/opt-1040-fix/page.tsx [app-rsc] (ecmascript)"));
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__eb23de23._.js.map