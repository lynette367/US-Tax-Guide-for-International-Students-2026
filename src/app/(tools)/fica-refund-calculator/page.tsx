  ...
  return (
    <main className="min-h-screen bg-[#fafafa]">
      ...
      <article className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        {/* Content Body */}
        <div className="prose prose-brand max-w-none mt-16 prose-headings:text-brand-ink prose-p:text-brand-ink/80 prose-li:text-brand-ink/80">
          
          <h2 className="text-2xl font-bold mt-12 mb-6 pb-2 border-b border-brand-pink/20">为什么 F1/OPT 学生通常不需要交 FICA 税？</h2>
          <div className="pl-4">
        ...
        {/* FAQ Section */}
        <section className="mt-16 pt-12 border-t border-brand-ink/10">
          <h2 className="text-2xl font-bold text-brand-ink mb-8">常见问题 (FAQ)</h2>
          <div className="grid gap-4">
            <details className="group rounded-[24px] border border-brand-pink/35 bg-white p-5 shadow-sm transition hover:shadow-md">
