...
export default function Form8843AmendGuidePage() {
    return (
                ...
                <div className="page-shell">
                    <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-8 lg:gap-12 items-start">
                        ...
                        <div className="mt-6 text-lg text-brand-ink/80 leading-relaxed">
                            <p>
                                很多同学发现自己 8843 寄早了，是因为还没搞清楚自己到底属于 Resident 还是 Non-resident。
                                在开始修正（Amend）之前，请先用下方工具确认你的 2026 报税身份：
                            </p>
                        </div>
                        ...
                        <div className="prose prose-pink max-w-none mt-10">
                            <h2 className="text-2xl sm:text-3xl font-semibold mt-12 mb-6 text-brand-ink">
                                为什么“寄早了”也需要修正？（常见场景：未等 1042-S 寄达）
                            </h2>
                            <p className="text-brand-ink/75 leading-7">
                                在 2026 报税季，很多同学在 2 月份就匆匆寄出了 Form 8843。
                                然而，到了 3 月份才收到学校寄来的 <strong>1042-S 表格</strong>（涉及奖学金或 Treaty 免税）。
                                如果你已经寄出了 8843 却忘了附上 1040-NR 或 1042-S，这会导致你的收入报告不完整。
                            </p>
                            <p className="text-brand-ink/75 leading-7 mt-4">
                                此外，如果你在 OPT 期间误把自己报成了 Resident（居民），漏掉了 8843，
                                这份漏掉的表可能会在未来成为你身份记录中的一个断点，必须通过修正申报来补齐。
                            </p>

                            <h2 className="text-2xl sm:text-3xl font-semibold mt-12 mb-6 text-brand-ink">
                                如何提交 Amended Return？修正 Form 8843 的具体步骤
                            </h2>
                            <p className="text-brand-ink/75 mb-4">修正申报通常涉及 <strong>Form 1040-X</strong>。虽然 8843 本身不是税表，但它经常需要配合修正后的税表一起寄送。</p>

                            <div className="space-y-6">
                                <div className="soft-card !bg-white border border-brand-pink/20">
                                    <h3 className="font-semibold text-brand-pinkdeep">步骤 1：下载并填写 Form 1040-X</h3>
                                    <p className="text-sm text-brand-ink/70 mt-2">
                                        在 1040-X 的 Explanation 部分，明确说明你是因为“漏交 Form 8843”或“重新判定 Non-resident 身份”而进行修正。
                                    </p>
                                </div>

                                <div className="soft-card !bg-white border border-brand-pink/20">
                                    <h3 className="font-semibold text-brand-pinkdeep">步骤 2：重新填写一份完整的 Form 8843</h3>
                                    <p className="text-sm text-brand-ink/80 mt-2">
                                        在新的 8843 表格顶部用红笔或黑色加粗字体标注：<strong>“AMENDED”</strong>。确保所有勾选项与你最新的身份判定一致。
                                    </p>
                                </div>

                                <div className="soft-card !bg-white border border-brand-pink/20">
                                    <h3 className="font-semibold text-brand-pinkdeep">步骤 3：组合寄送</h3>
                                    <p className="text-sm text-brand-ink/80 mt-2">
                                        将 1040-X、全新的 8843、以及原始申报的副本装在一起，邮寄至 IRS 修正申报专用地址。
                                    </p>
                                </div>
                            </div>

                            <h2 className="text-2xl sm:text-3xl font-semibold mt-12 mb-6 text-brand-ink">
                                填错 8843 会影响未来的 H1B 或绿卡申请吗？
                            </h2>
                            <p className="text-brand-ink/75 leading-7">
                                答案是：<strong>可能会</strong>。虽然 Form 8843 不直接涉及税金，但它是你维持“合法非居民”税务身份的唯一书面声明。
                                如果你连续多年漏交、或者在 OPT 期间因为填错 8843/1040 导致多拿了不该拿的 Standard Deduction，
                                在 H1B 审计或绿卡面试中，面试官可能会质疑你的税务合规性。
                            </p>
                            <p className="text-brand-ink/75 leading-7 mt-4">
                                好消息是，IRS 允许在 <strong>3 年法定追诉期</strong> 内进行合规修正。只要你主动提交了 Amended Return，
                                这种主动修正的行为通常会被视为“Good Faith Error Correction”，极大地降低了审计风险。
                            </p>

                            <div className="mt-12 rounded-[28px] border border-brand-pink/40 bg-white/95 p-8 shadow-[0_20px_60px_rgba(244,185,200,0.3)]">
                                <h2 className="text-xl sm:text-2xl font-bold mb-4 text-brand-ink">修正必备工具包</h2>
                                <div className="grid gap-6 sm:grid-cols-2">
                                    <div className="soft-card !bg-brand-pink/5">
                                        <h3 className="font-semibold mb-2">官方表格预览</h3>
                                        <p className="text-sm text-brand-ink/70 mb-4">修正申报通常需要的基础表单指南。</p>
                        ...
                        <section id="disclaimer" className="mt-16 pt-8 border-t border-brand-pink/20">
                            <p className="text-xs text-brand-ink/50 leading-relaxed">
                                ...
                                修正申报涉及复杂逻辑，建议在寄送前先核对原始申报底稿，或咨询 CPA 指导填写。
                            </p>
                        </section>
                    </article>
